# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-19 02:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_office', models.CharField(blank=True, max_length=140, null=True)),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='user',
            name='rol',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.Rol'),
        ),
        migrations.AddField(
            model_name='user',
